...
func TestGetTranslations_PerLocale(t *testing.T) {
	cases := []struct {
		...
		{"en", "Your Yaoguang Marketing authentication code"},
		{"fr", "Votre code d'authentification Yaoguang Marketing"},
		{"es", "Tu código de autenticación de Yaoguang Marketing"},
		{"de", "Ihr Yaoguang-Marketing-Authentifizierungscode"},
		{"ca", "El teu codi d'autenticació de Yaoguang Marketing"},
		{"pt-BR", "Seu código de autenticação da Yaoguang Marketing"},
		{"ja", "Yaoguang Marketing 認証コード"},
		{"it", "Il tuo codice di autenticazione Yaoguang Marketing"},
		{"zh-CN", "您的瑶光营销平台验证码"},
	}
