...
func (s *campaignSnapshotWorkerRepository) ListCampaignMembers(context.Context, string, domain.CampaignVersion, string, string, int) ([]domain.CampaignAudienceMember, string, error) {
	s.calls++
	if s.calls == 1 {
