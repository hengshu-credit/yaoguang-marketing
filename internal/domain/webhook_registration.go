...
//go:generate mockgen -destination mocks/mock_webhook_registration_service.go -package mocks github.com/hengshu-credit/yaoguang-marketing/internal/domain WebhookRegistrationService
