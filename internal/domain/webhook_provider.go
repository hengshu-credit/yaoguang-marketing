...
//go:generate mockgen -destination mocks/mock_webhook_provider.go -package mocks github.com/hengshu-credit/yaoguang-marketing/internal/domain WebhookProvider
