...
//go:generate mockgen -destination mocks/mock_contact_timeline_repository.go -package mocks github.com/hengshu-credit/yaoguang-marketing/internal/domain ContactTimelineRepository
