...
// Source: github.com/hengshu-credit/yaoguang-marketing/internal/domain (interfaces: ContactTimelineRepository)
...
func (m *MockContactTimelineRepository) ListByCustomer(arg0 context.Context, arg1, arg2 string, arg3 int, arg4 *string) ([]*domain.ContactTimelineEntry, *string, error) {
	m.ctrl.T.Helper()
...
func (mr *MockContactTimelineRepositoryMockRecorder) ListByCustomer(arg0, arg1, arg2, arg3, arg4 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListByCustomer", reflect.TypeOf((*MockContactTimelineRepository)(nil).ListByCustomer), arg0, arg1, arg2, arg3, arg4)
}
