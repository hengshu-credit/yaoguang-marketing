        ...
        <div className="absolute -right-8 top-1/2 -translate-y-1/2" style={{ zIndex: 10 }}>
          ...
          >
            <Tooltip title={t`Delete node`} placement="right">
              <button type="button" aria-label={t`Delete node`} className="flex items-center justify-center w-6 h-6 rounded-full bg-white hover:bg-red-50 shadow-md border border-gray-200 cursor-pointer transition-transform hover:scale-110">
