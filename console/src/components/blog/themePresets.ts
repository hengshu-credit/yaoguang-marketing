      ...
      <div class="footer-content">
        <div class="footer-left">
          ...
          <p class="text-gray-500 text-xs mt-1">
            Powered by <a href="https://hengshucredit.com" target="_blank" rel="noopener" style="color: var(--color-link); text-decoration: none;">Yaoguang Marketing</a>
          </p>
        </div>
        ...
        <div class="footer-links">
          ...
          <div class="social-links">
            <a href="https://hengshucredit.com" target="_blank" rel="noopener noreferrer" aria-label="Website">
            ...
            <a href="https://github.com/hengshu-credit/yaoguang-marketing" target="_blank" rel="noopener noreferrer"
              aria-label="GitHub">
              <svg class="social-icon" fill="currentColor" viewBox="0 0 24 24">
